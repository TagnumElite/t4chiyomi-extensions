...
object MDConstants {
    ...
    fun getSafeRatingPref(dexLang: String): String {
        return "${contentRatingPref}_${contentRatingPrefValSafe}_$dexLang"
    }

    fun getSuggestiveRatingPref(dexLang: String): String {
        return "${contentRatingPref}_${contentRatingPrefValSuggestive}_$dexLang"
    }

    fun getEroticaRatingPref(dexLang: String): String {
        return "${contentRatingPref}_${contentRatingPrefValErotica}_$dexLang"
    }

    fun getPornographicRatingPref(dexLang: String): String {
        return "${contentRatingPref}_${contentRatingPrefValPornographic}_$dexLang"
    }
    ...
    fun getJapaneseContentPref(dexLang: String): String {
        return "${originalLanguagePref}_${originalLanguagePrefValJapanese}_$dexLang"
    }

    fun getChineseContentPref(dexLang: String): String {
        return "${originalLanguagePref}_${originalLanguagePrefValChinese}_$dexLang"
    }

    fun getKoreanContentPref(dexLang: String): String {
        return "${originalLanguagePref}_${originalLanguagePrefValKorean}_$dexLang"
    }
}

    ...
    private fun getContentRating(preferences: SharedPreferences, dexLang: String): List<ContentRating> {
        return listOf(
            ContentRating("Safe").apply {
                state = preferences.getBoolean(MDConstants.getSafeRatingPref(dexLang), true)
            },
            ContentRating("Suggestive").apply {
                state = preferences.getBoolean(MDConstants.getSuggestiveRatingPref(dexLang), true)
            },
            ContentRating("Erotica").apply {
                state = preferences.getBoolean(MDConstants.getEroticaRatingPref(dexLang), false)
            },
            ContentRating("Pornographic").apply {
                state = preferences.getBoolean(MDConstants.getPornographicRatingPref(dexLang), false)
            },
        )
    }
    ...
    private fun getOriginalLanguage(preferences: SharedPreferences, dexLang: String): List<OriginalLanguage> {
        return listOf(
            OriginalLanguage("Japanese (Manga)", "ja").apply {
                state = preferences.getBoolean(MDConstants.getJapaneseContentPref(dexLang), false)
            },
            OriginalLanguage("Chinese (Manhua)", "zh").apply {
                state = preferences.getBoolean(MDConstants.getChineseContentPref(dexLang), false)
            },
            OriginalLanguage("Korean (Manhwa)", "ko").apply {
                state = preferences.getBoolean(MDConstants.getKoreanContentPref(dexLang), false)
            },
        )
    }
